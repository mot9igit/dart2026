  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        support: resolve(__dirname, "pages/services/support.html"),        
        consulting: resolve(__dirname, "pages/services/cansulting.html"),        
        ...
        portfolioProject: resolve(__dirname, "pages/portfolio/project.html"),        
        portfolioGalileosky: resolve(__dirname, "pages/portfolio/galileosky.html"),        
        portfolioSnegotehnika: resolve(__dirname, "pages/portfolio/snegotehnika.html"),        
        portfolioMst: resolve(__dirname, "pages/portfolio/mst.html"),        
        templates: resolve(__dirname, "pages/templates/index.html"),        
